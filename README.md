...
### 2. OpenAI API 키
- https://platform.openai.com/api-keys 에서 생성 (GPT-4.1 비전 호출 비용 발생)
...
- 분석: GPT-4.1 비전, `temperature=0`, `response_format=json_object` (프롬프트: `prompt.py`)
...
- **OpenAI 과금/에러**: API 키 크레딧, `gpt-4.1` 접근 권한 확인.
