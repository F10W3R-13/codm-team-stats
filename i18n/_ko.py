...
# 네비게이션
        ...
        "opp_rename": "이름 변경",
        "opp_rename_save": "변경",
        "opp_delete_team": "팀 삭제",
        "opp_confirm_delete_team": "팀을 삭제할까요? 매치 {n}건의 팀 태그가 해제되고 로스터가 삭제됩니다 (선수·스탯은 유지).",
        "opp_remove_roster": "로스터에서 제거",
        "opp_confirm_remove_roster": "{name}을(를) 이 팀 로스터에서 제거할까요?",
        "opp_unassign": "지정 해제",
        "opp_unassign_pick": "해제할 매치 선택",
        "opp_ignore_alias": "잘못된 별명 무시하고 재매칭",
        "opp_pending_more": "…외 {n}건 더 (최근 50건만 표시)",
        "opp_confirm_merge": "{dst}(으)로 병합할까요? 되돌릴 수 없습니다.",
        "opp_alias_title": "상대 선수 별명 관리",
        "opp_alias_hint": "OCR 표기 변형을 선수에게 수동 연결합니다. 삭제하면 다음 저장 시 재학습됩니다.",
        "opp_alias_ign": "별명(IGN)",
        "opp_alias_target": "선수",
        "opp_alias_add": "별명 등록",
        "opp_source_registered": "수동 등록",
        ...
        "versus_avg_margin": "평균 득실차",
        "versus_no_result": "미입력",
        "versus_back": "상대전적 목록으로",
        "versus_win_rate": "승률",
        "versus_games": "경기",
        "versus_empty_hint": "이 팀에 아직 지정된 매치가 없습니다. 관리 페이지에서 팀을 지정하세요.",
