...
#   - 캐시 키 = 인사이트 종류 + 대상 ID + 언어 + 시즌
#     (시즌별 인사이트 분리 — s1 아카이브 인사이트가 s2에 흘러드는 것 방지)
#
...
def set(kind: str, target: str, lang: str, insight: str, ttl: int = DEFAULT_TTL,
        fingerprint: str = None, season: str = None) -> None:
